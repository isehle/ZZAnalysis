...
class HistManager:
    ...
    def combine_eras(self, infile_1, infile_2, years, eras):
        ...
        if years[0]==years[1]:
            ...
            outfile = "/eos/user/i/iehle/Analysis/histograms/Full/hists_delRapidity_HMSSRelaxed_reweightNonDegEvents22_23_09_25.root"
   ...
   # def plot_zpx(self, infile_1, years, eras, infile_2=""):
    def plot_zpx(self, infile_1, infile_2=""):
        ...
        import json
        with open("ZpX_info_2022_Full_reweightNonDegEvents_22_09_25.json", "w") as myfile:
        ...
        if infile_2 != "":
            ...
            for step in zpx_info_1.keys():
                ...
                fig.savefig(f"zpx_reweightNonDegEvents_{step}_{year}_{era}_22_09_25.png")
...
if __name__ == "__main__":
    ...
    #hist_manager.plot_zpx("/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_keepDegenerateEvents_AllMC_15_09_25.root")
    #hist_manager.plot_zpx("/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_reweightNonDegEvents_22_09_25.root")
    ...
    #     infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_reweightNonDegEvents_HighMassSSRelaxed_23_09_25.root",
    #     infile_2 = "/eos/user/i/iehle/Analysis/histograms/2023/Full/hists_dataInCRs.root",
    #     years    = (2022, 2023),
    #     eras     = ("Full", "Full")
    # )
    ...
    # hist_manager.combine_eras(
    #     infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/CD/hists_RemoveDeg_22_09_25.root",
    #     infile_2 = "/eos/user/i/iehle/Analysis/histograms/2022/EFG/hists_RemoveDeg_22_09_25.root",
    #     years    = (2022, 2022),
    #     eras     = ("CD", "EFG")
    # )

    hist_manager.combine_eras(
        infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/CD/hists_keepDegEvents_AllFstates_AllCRs_AllSysts.root",
        infile_2 = "/eos/user/i/iehle/Analysis/histograms/2022/EFG/hists_keepDegEvents_AllFstates_AllCRs_AllSysts.root",
        years    = (2022, 2022),
        eras     = ("CD", "EFG")
    )

    # hist_manager.combine_eras(
    #     infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/CD/hists_reweightNonDegEvents_22_09_25.root",
    #     infile_2 = "/eos/user/i/iehle/Analysis/histograms/2022/EFG/hists_reweightNonDegEvents_22_09_25_v2.root",
    #     years    = (2022, 2022),
    #     eras     = ("CD", "EFG")
    # )

    # hist_manager.combine_eras(
    #     infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/CD/hists_reweightDegEvents_HighMassSSRelaxed_23_09_25.root",
    #     infile_2 = "/eos/user/i/iehle/Analysis/histograms/2022/EFG/hists_reweightDegEvents_HighMassSSRelaxed_23_09_25.root",
    #     years    = (2022, 2022),
    #     eras     = ("CD", "EFG")
    # )

    # hist_manager.combine_eras(
    #     infile_1 = "/eos/user/i/iehle/Analysis/histograms/2022/CD/hists_keepDegenerateEvents_AllMC_15_09_25.root",
    #     infile_2 = "/eos/user/i/iehle/Analysis/histograms/2022/EFG/hists_keepDegenerateEvents_AllMC_15_09_25.root",
    #     years    = (2022, 2022),
    #     eras     = ("CD", "EFG")
    # )
    ...
    # hist_manager.plot_hists(
    #     #"/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_keepDegenerateEvents_AllMC_15_09_25.root",
    #    # "/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_RemoveDeg_22_09_25.root",
    #    #"/eos/user/i/iehle/Analysis/histograms/2022/Full/hists_reweightNonDegEvents_22_09_25.root",
    #     rebin=True,
    #     mass = dict(
    #         HighMass = dict(
    #             bins     = [180., 200., 220., 240., 260., 280., 300., 320., 340., 360., 380., 400., 420.],
